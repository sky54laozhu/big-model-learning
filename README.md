...
>
> **进度：概念系列 32 篇正文 + 2 番外 · 完结 🎉 ｜ 实战卷《从 0 写一个 Harness》进行中（15/20）｜ 独立系列《从 0 到精通 TypeScript》进行中（3/21）**
...
| 实战14 | [取消一个后台任务：一个 AbortSignal，怎么让两处真的被打断](blogs/实战14-task-cancellation.md) | ✅ |
| 实战15 | [主动查一次后台任务：两张表合一张，问法却分两种](blogs/实战15-task-status-query.md) | ✅ |
...
| # | 标题 | 状态 |
|---|------|:----:|
| 卷首语 | [给会写代码的人，补一门类型课](blogs/ts00-preface.md) | ✅ |
| ts01 | [类型是什么：一组允许的值](blogs/ts01-type-is-a-set.md) | ✅ |
| ts02 | [注解 vs 推断：谁来决定一个槽的集合](blogs/ts02-annotation-vs-inference.md) | ✅ |
