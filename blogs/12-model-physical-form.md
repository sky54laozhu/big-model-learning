...
这也直接回答了标题：70B 要多少显卡？看你用什么精度——FP16 要两张 80GB 的专业卡；量化到 INT4 只剩 35GB，单张 24GB 的 RTX 4090 还差一点，但双卡 4090、或一张 48GB 的专业卡（如 A6000），就能跑推理了。**量化，就是把大模型搬进小显卡的关键魔法。**
...
- **Blog 09 说"全量微调显存爆炸"**——爆的就是上面那条尾巴：700 亿个参数，每个都要算梯度、存两份优化器状态。
